...
const ProblemDescription = () => {
  return (<div className=' bg-slate-300   dark:text-gray-200    dark:bg-dark-layer-1'>
  {/* TAB */}
  <div className='flex h-11 w-full items-center pt-2 bg-gray-500 text-white overflow-x-hidden'>
