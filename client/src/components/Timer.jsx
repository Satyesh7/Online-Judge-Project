...
const Timer = () => {
  ...
  return (
    <div>
      {showTimer ? (
        <div className="flex items-center space-x-2 bg-black p-1.5 cursor-pointer rounded hover:bg-gray-500">
        ...
        <div
          className="flex items-center p-1 h-8 hover:bg-gray-600 rounded cursor-pointer"
